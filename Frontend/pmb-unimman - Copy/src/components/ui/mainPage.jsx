...
const MainPage = () => {
    ...
    // Di src/components/ui/mainPage.jsx
    // Update function handleSearch ini:
    ...
    const handleSearch = () => {
        ...
        // Buat query string dari parameter yang dipilih
        ...
        // Navigate ke halaman jalur pendaftaran dengan parameter
